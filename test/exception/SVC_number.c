 ...
 ******************************************************************************
 * @attention
 * - Goal: Write a program to execute an SVC instruction from thread mode,
 *implement the SVC handler to print the SVC number used. Also, increment the
 *SVC number by 4 and return it to the thread mode code and print it.
 * 1. Write a main() function where you should execute the SVC instruction with
 *an argument. Using SVC #0x05 in this case.

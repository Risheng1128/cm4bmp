 ...
 ******************************************************************************
 * @attention
 * 	Example 1: Load 2 values from memory, add them and storage it to memory by
 *using inline assembly statement Example 2: 讀取 "Control Register" Example 3:
 *把一個變數複製到另一個變數 Example 4: 把一個位址的值寫到另一個變數裡
 */

...
#define GPIOA_MODER         *(volatile uint32_t*)0x48000000U // GPIO port mode register
#define GPIOA_OTYOER        *(volatile uint32_t*)0x48000004U // GPIO port output type register
#define GPIOA_PUPDR         *(volatile uint32_t*)0x4800000CU // GPIO port pull-up/pull-down register
#define GPIOA_AFRH          *(volatile uint32_t*)0x48000024U // GPIO alternate function high register
